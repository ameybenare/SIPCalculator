<script>
  ...
  <style>
    ...
    .range__wrapper:focus-visible > .range__track {
      box-shadow: 0 0 0 2px white, 0 0 0 3px var(--track-focus, #00d09c);
    }
    ...
    .range__track--highlighted {
      ...
      background: var(
        --track-highlight-bg,
        linear-gradient(90deg, #6185ff, #00d09c)
      );
      width: 0;
      height: 6px;
      position: absolute;
    ...
    .range__tooltip {
      ...
      border-radius: 4px;
      text-align: center;
      background-color: var(--tooltip-bgcolor, #00d09c);
      background: var(--tooltip-bg, linear-gradient(45deg, #00d09c, #9c65ff));
    }
